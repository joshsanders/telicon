# Telicon
A telecom-centric, SVG-based icon font designed for Monster UI&mdash;an interface layer for the Unified Communications platform KAZOO.

<h1 align="center"><img src="https://.svg" alt="Telicon" width="50%"></h1>
